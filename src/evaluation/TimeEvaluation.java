...
public class TimeEvaluation {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sequential S0C Set in firstpasstest: " + fpTest.getS0C().getS0CSet());
		...
		System.out.println("Sequential Sk1C set in secondpasstest: " + spTest.getSk1C().getSk1CSet());
		...
		fpTest.dfsFirstPass();
		//System.out.println("R0C Set in firstpasstest: " + fpTest.getR0C().getR0CSet());
		System.out.println("If S0C Set in firstpasstest: " + fpTest.getS0C().getS0CSet());
		...
		//System.out.println("BkC Set in secondpasstest: " + spTest.getBkC().getBkCSet());
		//System.out.println("Rk1C set in secondpasstest: " + spTest.getRk1C().getRk1CSet());
		System.out.println("If Sk1C set in secondpasstest: " + spTest.getSk1C().getSk1CSet());
		...
		fpTest.dfsFirstPass();
		//System.out.println("R0C Set in firstpasstest: " + fpTest.getR0C().getR0CSet());
		System.out.println("Loops S0C Set in firstpasstest: " + fpTest.getS0C().getS0CSet());
		...
		//System.out.println("BkC Set in secondpasstest: " + spTest.getBkC().getBkCSet());
		//System.out.println("Rk1C set in secondpasstest: " + spTest.getRk1C().getRk1CSet());
		System.out.println("Loops Sk1C set in secondpasstest: " + spTest.getSk1C().getSk1CSet());
